...
Easily extend Twenty by installing add-ons for the tools you already use.

1. Open **Settings → Marketplace** from the sidebar menu.
2. Search for marketing automation, accounting, or other integrations.
3. Click **Install** and follow the prompts to connect your account.

Once installed, data syncs automatically between Twenty and the selected tool.
